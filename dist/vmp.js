...
var InViewBanner = __webpack_require__(1);
var InPageBanner = __webpack_require__(4);
...
function InViewBanner(configs){
	...
	banner.append($('<img/>').attr('src', INFO_IMAGE));
	banner.append($('<img/>').attr('src', CLOSE_IMAGE));
